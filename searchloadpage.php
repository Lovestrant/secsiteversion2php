...
<div id="postsclass3">
         ...
         <?php
            ...
            if(isset($_POST['searchbtn'])) {
                ...
                $sql = "SELECT * FROM secsite WHERE caption LIKE '%$search%'";
                ...
                if($queryResult > 0) {
                    ...
                    <div >
                        ...
                        <div  style='height: auto;width: 100%; border-radius: 0px;text-align: left; 
                        color:white; margin-left:0%; padding:10px; background-color: grey; '>".$row['caption']."</div>
                        ...
                        ";
                            ...
                            echo"
                        <p style='border-bottom: 2px solid indigo; margin-top: 5%; margin-bottom: 10%;text-align: centre;background-color: transparent;'>
